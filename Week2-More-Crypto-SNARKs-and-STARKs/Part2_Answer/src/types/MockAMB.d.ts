...
interface MockAMBInterface extends ethers.utils.Interface {
  functions: {
    ...
    "xDomainMessageChainId()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "xDomainMessageChainId",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class MockAMB extends BaseContract {
  ...
  functions: {
    ...
    xDomainMessageChainId(overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    setMessageSender(_sender: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    xDomainMessageChainId(overrides?: CallOverrides): Promise<BigNumber>;
