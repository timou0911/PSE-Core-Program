...
interface CrossChainUpgradeableProxyInterface extends ethers.utils.Interface {
  functions: {
...
export class CrossChainUpgradeableProxy extends BaseContract {
  ...
  interface: CrossChainUpgradeableProxyInterface;
