...
interface WETHOmnibridgeRouterInterface extends ethers.utils.Interface {
  functions: {
...
export class WETHOmnibridgeRouter extends BaseContract {
  ...
  interface: WETHOmnibridgeRouterInterface;
